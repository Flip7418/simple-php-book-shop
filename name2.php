...
if ($genre!='all'){
    $query = "SELECT book_isbn, book_image,book_title,book_price FROM books WHERE book_genre ='$genre' ORDER BY book_title DESC";
  }
  if ($genre=='all'){
    $query = "SELECT book_isbn, book_image,book_title,book_price FROM books ORDER BY book_title DESC";
}
